...
META_DATA_TO_INCLUDE = ["file_name", "participant_id", "text", "data"] # specifies which metadata is included in the dataset , recommended is ["file_name", "file_path", "participant_id", "text", "data"]
...
SCREEN_RESOLUTION =  {"Goettingen" : (1920, 1080)}  # monitor resolution in pixels,
