...
def create_mp_metadata(img_with_paths: str, out_dir: dir, data_regex = "data/**/raw_data/*.csv", data_to_include = META_DATA_TO_INCLUDE, datacollection_name = "Goettingen") -> None:
